...
export default function Home() {
  ...
  <script src="https://www.paypal.com/sdk/js?client-id=ASVavUkagd5sU2AWY7sdsrLkjneoxYUUPCIpGaALhOA28j4KHp2d5s98iQORa6lapulXKrTC7pPQMLdM&enable-funding=venmo&currency=USD" data-sdk-integration-source="button-factory"></script>
  <script>
      ...
      paypal.Buttons({
        ...
        createOrder: function(data, actions) {
          return actions.order.create({
            purchase_units: [{"description":"Web Resources FOR BRM SCHOOL","amount":{"currency_code":"USD","value":255}}]
          });
        },
